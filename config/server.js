...
module.exports = {
	...
	apiBaseUrl: process.env.API_BASE_URL || `http://165.22.79.116/api/v1`,

	// Access-Control-Allow-Origin
	storeBaseUrl: process.env.STORE_BASE_URL || `http://165.22.79.116:3000`,

	// used by API
	adminBaseURL: process.env.ADMIN_BASE_URL || 'http://165.22.79.116:3002',
